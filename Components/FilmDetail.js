...
import EnlargeShrink from '../Aniamtion/EnlargeShrink'
...
class FilmDetail extends React.Component {
    ...
    componentDidMount () {
        const favoritesFilmIndex = this.props.favoritesFilm.findIndex(item => item.id === this.props.route.params.idFilm)
